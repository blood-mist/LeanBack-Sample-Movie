...
import stb.androidtv.moviesleanback.utils.DefaultDataSourceFactory;
...
public class ExoPlayerAdapter extends PlayerAdapter implements Player.EventListener {
    ...
    private void prepareMediaForPlaying() {
        ...
        setAudioStreamType(mAudioStreamType);
    ...
    /**
     * If SeekProvider is given, seeking probably needs thumbnails of the video,
     * instead enable seek function from glue and give play command as seeking will pause the video
     * internally
     */
    @Override
