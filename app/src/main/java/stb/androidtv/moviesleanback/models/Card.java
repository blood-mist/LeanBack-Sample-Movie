...
package stb.androidtv.moviesleanback.models;
...
public class Card implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.mExtraText);
        dest.writeString(this.mImageUrl);
        dest.writeString(this.mFooterColor);
        dest.writeString(this.mSelectedColor);
        dest.writeString(this.mLocalImageResource);
        dest.writeString(this.mFooterResource);
    ...
    protected Card(Parcel in) {
        ...
        this.mExtraText = in.readString();
        this.mImageUrl = in.readString();
        this.mFooterColor = in.readString();
        this.mSelectedColor = in.readString();
        this.mLocalImageResource = in.readString();
        this.mFooterResource = in.readString();
