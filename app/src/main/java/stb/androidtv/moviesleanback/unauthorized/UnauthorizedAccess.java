package stb.androidtv.moviesleanback.unauthorized;
...
public class UnauthorizedAccess extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        error_code = getIntent().getStringExtra(MOVIE_ERROR_CODE);
        error_message = getIntent().getStringExtra(MOVIE_ERROR_MESSAGE);
