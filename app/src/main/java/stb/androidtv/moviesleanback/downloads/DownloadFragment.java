package stb.androidtv.moviesleanback.downloads;
...
import stb.androidtv.moviesleanback.enitities.Download;
...
import static stb.androidtv.moviesleanback.utils.LinkConfig.MESSAGE_ERROR;
import static stb.androidtv.moviesleanback.utils.LinkConfig.MESSAGE_PROGRESS;
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(MESSAGE_PROGRESS)) {
                ...
                downloadProgressBar.getProgressDrawable().setColorFilter(ContextCompat.getColor(context, R.color.red_color), PorterDuff.Mode.SRC_IN);
