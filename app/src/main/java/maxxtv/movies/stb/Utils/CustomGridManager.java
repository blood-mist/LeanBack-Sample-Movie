...
/**
 * {@link CustomGridManager} extension which introduces workaround for focus finding bug when
...
public class CustomGridManager extends GridLayoutManager {
    ...
    public CustomGridManager(Context context, int spanCount, int orientation,
